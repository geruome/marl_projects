                ...
                for event_str in tf.compat.v1.io.tf_record_iterator(event_file):
                    ...
                    if event.step is not None and event.HasField('summary'):
                        for value in event.summary.value:
                            if value.tag.endswith('train_reward'):
...
if __name__ == "__main__":
    ...
    my_log_configs = [
        ...
        ('expe/0603_1720_hybrid/log', 'Hybrid')
    ]
    ...
    plot_multiple_tensorboard_rewards_smoothed(
        ...
        std_multiplier=0.0, # std_multiplier for rewards can be adjusted if you want shade
    ...
    def combine_images_vertically_and_horizontally(image_paths, output_path="plot/fig.png"):
        """
        ...
        Assumes bottom image (rewards) is already pre-resized.
        ...
        try:
            ...
            final_height = max_top_height + img_bottom.height
            ...
            combined_img.paste(img_bottom, (0, max_top_height)) # Bottom, below the top combined images
    ...
    image_paths_for_combination = {
        'top_left': 'plot/queue.png',
        'top_right': 'plot/delay.png',
        'bottom': 'plot/rewards.png'
    }
    output_file_for_combination = os.path.join('plot', 'fig.png')

    print("\n--- Starting Final Image Combination Process ---")
    combine_images_vertically_and_horizontally(image_paths_for_combination, output_file_for_combination)
    print("--- Final Image Combination Process Completed ---")